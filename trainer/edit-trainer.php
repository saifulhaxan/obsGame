    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold"><a href="#" class="text-dark text-decoration-none"><i class="bi bi-chevron-left"></i> Edit Trainer</a></h3>
            </div>
        </div>
    </div>
    <div class="report-section shadow px-5 py-4 rounded-15 my-4">
        ...
        <form action="">
            <div class="row mb-4">
                <div class="col-md-5">
                    <div class="form-group py-2">
                        ...
                        <input type="text" value="Mark" name="firstName" placeholder="Enter First Name" class="form-control border-0 rounded-pill shadow">
                    </div>
                    <div class="form-group py-2">
                        <label for="lastName">
                            Last Name: <span class="required text-danger">*</span>
                        </label>
                        <input type="text" value="Jhon" name="lastName" placeholder="Enter Last Name" class="form-control border-0 rounded-pill shadow">
                    </div>
                    <div class="form-group py-2">
                        <label for="lastName">
                            Email Address: <span class="required text-danger">*</span>
                        </label>
                        <input type="email" value="mark@gmail.com" name="email" placeholder="Enter Email Address" class="form-control border-0 rounded-pill shadow">
                    </div>
                    <div class="form-group py-2">
                        <label for="lastName">
            ...
            <div class="editBtn py-4">
                <button type="button" class="btn bg-theme-primary text-white px-5 rounded-pill py-2" data-toggle="modal" data-target="#tranerEdit">Update</button>
            </div>
        </form>
    </div>
</div>
