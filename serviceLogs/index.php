    ...
    <div class="row align-items-center justify-content-between">
        <div class="col-md-12">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Payment Logs</h3>
            </div>
        </div>
    </div>
                ...
                <table class="table text-center">
                    <thead>
                        <tr>
                            ...
                            <th class="table-site-headings">ID</th>
                            <th class="table-site-headings">User Name</th>
                            <th class="table-site-headings">Email</th>
                            <th class="table-site-headings">Game Title</th>
                            <th class="table-site-headings">Date of Ending</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>mm/dd/yyyy</td>
                            <td>£70</td>
                            <td> <span class="primary-status status-active">Completed</span></td>
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item mb-1" href='./service-detail-completed.php'><i class="bi bi-eye table-eye pr-2"></i>View</a>
                        ...
                        <tr>
                            ...
                            <td>mm/dd/yyyy</td>
                            <td>£70</td>
                            <td> <span class="primary-status status-active">Upcoming</span></td>
                            <td>
                                <div class="btn-group ml-1">
                                    <button type="button" class="btn border-color outline-0" data-toggle="dropdown" aria-expanded="false"> <i class="bi bi-three-dots-vertical"></i> </button>
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item mb-1" href='./service-detail.php'><i class="bi bi-eye table-eye pr-2"></i>View</a>
                                        <!-- <button class="dropdown-item mb-1"><i class="bi bi-x-circle pr-2"></i>In-Active</button>
                                        <button class="dropdown-item mb-1"><i class="bi bi-pencil pr-2"></i>Edit</button> -->
                                    </div>
                                </div>
