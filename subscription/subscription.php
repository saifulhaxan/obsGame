    ...
    <div class="row align-items-center justify-content-between">
        <div class="col-md-4">
            <div class="titleBox py-4">
                <h3 class="mb-0 achivpFont mb-0 font-weight-bold">Subscription - Listing</h3>
            </div>
        </div>
        <div class="col-md-4">
            <div class="titleBox py-4">
                <div class="addPackages text-md-right">
                    <a href="#" class="btn rounded-pill px-4">Add User</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <td>
                                <div class="btn-group ml-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <button class="dropdown-item mb-1" href="./business-plan.php"><i class="bi bi-eye table-eye pr-2"></i>View</button>
